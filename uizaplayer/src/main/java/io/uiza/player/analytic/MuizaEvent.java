...
import static io.uiza.player.analytic.MuizaEvent.MUIZA_EVENT_ERROR;
import static io.uiza.player.analytic.MuizaEvent.MUIZA_EVENT_FULLSCREENCHANGE;
import static io.uiza.player.analytic.MuizaEvent.MUIZA_EVENT_LOADSTART;
import static io.uiza.player.analytic.MuizaEvent.MUIZA_EVENT_PAUSE;
import static io.uiza.player.analytic.MuizaEvent.MUIZA_EVENT_PLAY;
import static io.uiza.player.analytic.MuizaEvent.MUIZA_EVENT_PLAYING;
import static io.uiza.player.analytic.MuizaEvent.MUIZA_EVENT_RATECHANGE;
import static io.uiza.player.analytic.MuizaEvent.MUIZA_EVENT_READY;
import static io.uiza.player.analytic.MuizaEvent.MUIZA_EVENT_REBUFFEREND;
import static io.uiza.player.analytic.MuizaEvent.MUIZA_EVENT_REBUFFERSTART;
import static io.uiza.player.analytic.MuizaEvent.MUIZA_EVENT_SEEKED;
import static io.uiza.player.analytic.MuizaEvent.MUIZA_EVENT_SEEKING;
import static io.uiza.player.analytic.MuizaEvent.MUIZA_EVENT_VIEWENDED;
import static io.uiza.player.analytic.MuizaEvent.MUIZA_EVENT_VIEWSTART;
import static io.uiza.player.analytic.MuizaEvent.MUIZA_EVENT_VOLUMECHANGE;
import static io.uiza.player.analytic.MuizaEvent.MUIZA_EVENT_WAITING;
