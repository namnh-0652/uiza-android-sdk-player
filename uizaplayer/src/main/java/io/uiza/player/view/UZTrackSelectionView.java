...
public class UZTrackSelectionView extends LinearLayout {
    ...
    /**
     * Gets a pair consisting of a dialog and the {@link com.google.android.exoplayer2.ui.TrackSelectionView}
     * that will be shown by it.
     *
     * @param context The parent activity.
     * @param title The dialog's title.
     * @param trackSelector The track selector.
     * @param rendererIndex The index of the renderer.
     * @return The dialog and the {@link com.google.android.exoplayer2.ui.TrackSelectionView} that
     * will be shown by it.
     */
    public static Pair<AlertDialog, UZTrackSelectionView> getDialog(
        ...
        final UZTrackSelectionView selectionView = dialogView
                .findViewById(R.id.uz_track_selection_view);
    ...
    public UZTrackSelectionView(Context context, @Nullable AttributeSet attrs) {
    ...
    public UZTrackSelectionView(Context context, @Nullable AttributeSet attrs,
        ...
        disableView = (CheckedTextView) inflater
                .inflate(android.R.layout.simple_list_item_single_choice, this, false);
        ...
        defaultView = (CheckedTextView) inflater
                .inflate(android.R.layout.simple_list_item_single_choice, this, false);
    ...
    private void updateViews() {
        ...
        for (int groupIndex = 0; groupIndex < trackGroups.length; groupIndex++) {
            ...
            for (int trackIndex = 0; trackIndex < group.length; trackIndex++) {
                ...
                CheckedTextView trackView = (CheckedTextView) inflater
                        .inflate(trackViewLayoutId, this, false);
                ...
                uzItem.setFormat(UZUtil.getFormatVideo(trackView.getText().toString()));
