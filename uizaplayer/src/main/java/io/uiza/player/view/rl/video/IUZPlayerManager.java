...
import io.uiza.player.util.GlideThumbnailTransformationPB;
...
public abstract class IUZPlayerManager implements PreviewLoader {
    ...
    class UZPlayerEventListener implements Player.EventListener {
        ...
        public void onTimelineChanged(Timeline timeline, Object manifest, int reason) {
            ...
            if (manifest instanceof HlsManifest) {
                ...
                long elapsedTime =
                        SystemClock.elapsedRealtime() - UZUtil.getLastElapsedTime(context);
