...
import io.uiza.player.interfaces.UZBufferCallback;
...
import io.uiza.player.mini.pip.FUZVideoService;
import io.uiza.player.util.ComunicateMng;
import io.uiza.player.util.SensorOrientationChangeNotifier;
import io.uiza.player.util.UZData;
import io.uiza.player.util.UZInput;
...
import io.uiza.player.view.dlg.UZDlgInfoV1;
import io.uiza.player.view.dlg.UZDlgSpeed;
import io.uiza.player.view.dlg.hq.UZItem;
import io.uiza.player.view.dlg.playlistfolder.CallbackPlaylistFolder;
import io.uiza.player.view.dlg.playlistfolder.UZDlgPlaylistFolder;
...
public class UzVideo extends RelativeLayout
        implements PreviewView.OnPreviewChangeListener, View.OnClickListener,
    ...
    public void initCustomLinkPlay(@NonNull String videoUrl, boolean isLivestream) {
        ...
        initDataSource(videoUrl, UZData.getInstance().getUrlIMAAd(),
                UZData.getInstance().getUrlThumnailsPreviewSeekbar(), subtitleList,
    ...
    public void toggleStatsForNerds() {
        if (getPlayer() == null || statsForNerdsHelper == null) {
            return;
        }
    ...
    protected void tryNextLinkPlay() {
        ...
        countTryLinkPlayError++;
        Log.e(TAG, getContext().getString(R.string.cannot_play_will_try) + ": "
                + countTryLinkPlayError);
        releaseUzPlayerManager();
    ...
    public void initializePiP() {
        if (getContext() == null || uzPlayerManager == null
                || uzPlayerManager.getLinkPlay() == null) {
            notifyError(UzExceptionUtil.getExceptionShowPip());
            return;
        }
        UzDisplayUtil.goneViews(ibPictureInPictureIcon);
            ...
            UzApiMaster.getInstance().subscribe(
                    ...
                    new ApiSubscriber<BasePaginationResponse<List<VideoData>>>() {
                        ...
                        public void onSuccess(BasePaginationResponse<List<VideoData>> response) {
                            if (response == null || response.getMetadata() == null || response
                                    .getData()
                                    .isEmpty()) {
                                if (uzCallback != null) {
    ...
    private void handleClickPlaylistFolder() {
        UZDlgPlaylistFolder UZDlgPlaylistFolder = new UZDlgPlaylistFolder(getContext(), isLandscape,
                UZData.getInstance().getDataList(),
                UZData.getInstance().getCurrentPositionOfDataList(), new CallbackPlaylistFolder() {
            @Override
    ...
    private void handleClickCC() {
        if (uzPlayerManager.getSubtitleList() == null || uzPlayerManager.getSubtitleList()
                .isEmpty()) {
            UZDlgInfoV1 uzDlgInfoV1 = new UZDlgInfoV1(getContext(),
    ...
    public void showSpeed() {
        ...
        final UZDlgSpeed uzDlgSpeed = new UZDlgSpeed(getContext(),
                getPlayer().getPlaybackParameters().speed, new UZDlgSpeed.Callback() {
            @Override
    ...
    private void setEventForViews() {
        setClickAndFocusEventForViews(ibFullscreenIcon, ibBackScreenIcon, ibVolumeIcon,
                ...
                ibRewIcon, ibPlayIcon, ibPauseIcon, ibReplayIcon, ibSkipNextIcon,
                ibSkipPreviousIcon, ibSpeedIcon);
    }
    ...
    public void setUrlImgThumbnail(String urlImgThumbnail) {
        ...
        if (ivVideoCover.getVisibility() != VISIBLE) {
            ...
            UzImageUtil
                    .load(getContext(), urlImgThumbnail, ivVideoCover, R.drawable.background_black);
        }
    }
    ...
    public void setProgressSeekbar(final UzVerticalSeekBar uzVerticalSeekBar,
    ...
    public void updateUIFocusChange(View view, boolean isFocus) {
        ...
        if (isFocus) {
            if (view instanceof UzImageButton) {
                UZUtil.updateUIFocusChange(view, isFocus, R.drawable.bkg_tv_has_focus,
                ...
                UZUtil.updateUIFocusChange(view, isFocus, R.drawable.bkg_tv_has_focus_uz_timebar,
    ...
    public void addControllerStateCallback(
    ...
    private void callAPIGetDetailEntity() {
        ...
        if (isDataExist) {
            ...
            if (isLivestream) {
                UZUtil.getDataFromEntityIdLive(getContext(), entityId,
    ...
    private void callAPIGetTokenStreaming() {
        ...
        if (isGetTokenStreamingExist) {
            ...
            UzApiMaster.getInstance()
                    .subscribe(service.getTokenStreaming(UZData.getInstance().getAPIVersion(),
                            streamingTokenRequest),
                            new ApiSubscriber<BaseResponse<StreamingToken>>() {
                                @Override
                                public void onSuccess(BaseResponse<StreamingToken> response) {
                                    if (response == null || response.getData() == null
                                            || response.getData().getToken() == null || response
                                            .getData().getToken().isEmpty()) {
    ...
    private void callAPIGetLinkPlay() {
        ...
        if (isResultGetLinkPlayExist) {
            ...
            if (isLivestream) {
                ...
                UzApiMaster.getInstance()
                        .subscribe(service.getLinkPlay(appId, entityId, typeContent),
                                new ApiSubscriber<BaseResponse<LinkPlay>>() {
                                    @Override
                                    public void onSuccess(BaseResponse<LinkPlay> response) {
                                        handleLinkPlayResponse(response.getData());
    ...
    private void checkData() {
        UZData.getInstance().setSettingPlayer(true);
        isHasError = false;
        if (UZData.getInstance().getEntityId() == null || UZData.getInstance().getEntityId()
                .isEmpty()) {
    ...
    private void checkToSetUpResource() {
        if (UZData.getInstance().getLinkPlay() != null && UZData.getInstance().getData() != null) {
            ...
            if (isCalledFromChangeSkin) {
                ...
                initDataSource(videoUrl, null, UZData.getInstance().getUrlThumnailsPreviewSeekbar(),
    ...
    private void initDataSource(String linkPlay, String urlIMAAd,
        ...
        if (includeAds) {
            uzPlayerManager = new UZPlayerManager(this, linkPlay, urlIMAAd,
    ...
    protected void trackProgress(int s, int percent) {
        ...
        if (s == (isLivestream ? 3 : 5)) {
            if (!UzTrackingHelper.isTrackedEventTypeView(getContext())) {
                callAPITrackUiza(UZData.getInstance()
        ...
        if (percent >= Constants.PLAYTHROUGH_100) {
            ...
            if (UzTrackingHelper.isTrackedEventTypePlayThrough100(getContext())) {
                ...
                callAPITrackUiza(UZData.getInstance()
                                .createTrackingInput(getContext(), PLAY_THROUGH_100,
            ...
            if (UzTrackingHelper.isTrackedEventTypePlayThrought75(getContext())) {
                ...
                callAPITrackUiza(UZData.getInstance()
                                .createTrackingInput(getContext(), PLAY_THROUGH_75,
                                        VideoTrackingEvent.EVENT_TYPE_PLAY_THROUGH),
                        new UzTrackingHelper.UizaTrackingCallback() {
                            @Override
                            public void onTrackingSuccess() {
            ...
            if (UzTrackingHelper.isTrackedEventTypePlayThrought50(getContext())) {
                ...
                callAPITrackUiza(UZData.getInstance()
                                .createTrackingInput(getContext(), PLAY_THROUGH_50,
                                        VideoTrackingEvent.EVENT_TYPE_PLAY_THROUGH),
                        new UzTrackingHelper.UizaTrackingCallback() {
                            @Override
                            public void onTrackingSuccess() {
            ...
            if (UzTrackingHelper.isTrackedEventTypePlayThrought25(getContext())) {
                ...
                callAPITrackUiza(UZData.getInstance()
                                .createTrackingInput(getContext(), PLAY_THROUGH_25,
                                        VideoTrackingEvent.EVENT_TYPE_PLAY_THROUGH),
                        new UzTrackingHelper.UizaTrackingCallback() {
                            @Override
                            public void onTrackingSuccess() {
    ...
    private void trackUizaEventVideoStarts() {
        ...
        if (!UzTrackingHelper.isTrackedEventTypeVideoStarts(getContext())) {
            callAPITrackUiza(UZData.getInstance()
                            .createTrackingInput(getContext(), VideoTrackingEvent.EVENT_TYPE_VIDEO_STARTS),
                    new UzTrackingHelper.UizaTrackingCallback() {
                        @Override
                        public void onTrackingSuccess() {
                            UzTrackingHelper
                                    .setTrackingDoneWithEventTypeVideoStarts(getContext(), true);
                        }
                    });
        }
    }
    ...
    private void pingHeartBeat() {
        if (getContext() == null || cdnHost == null || cdnHost.isEmpty()) {
            LLog.e(TAG, "Error cannot call API pingHeartBeat() -> cdnHost: " + cdnHost
                    + ", entityName: " + UZData.getInstance().getEntityName() + " -> return");
            return;
        }
        if (activityIsPausing) {
            rePingHeartBeat();
            LLog.e(TAG,
                    "Error cannot call API pingHeartBeat() because activity is pausing " + UZData
    ...
    private void trackUizaCCUForLivestream() {
        ...
        if (activityIsPausing) {
            ...
            LLog.e(TAG,
                    "Error cannot trackUizaCCUForLivestream() because activity is pausing " + UZData
                            .getInstance().getEntityName());
            return;
        }
        UzServiceApi service = UzRestClientTracking.createService(UzServiceApi.class);
    ...
    private void callAPITrackMuiza(int s) {
        if (isInitCustomLinkPlay || (s <= 0 || s % 10 != 0) || isTrackingMuiza || UZData
                .getInstance().isMuizaListEmpty()) {
            return;
        }
    ...
    public void onMessageEvent(ComunicateMng.MsgFromService msg) {
        ...
        if (msg instanceof ComunicateMng.MsgFromServiceOpenApp) {
            ...
            try {
                positionMiniPlayer = ((ComunicateMng.MsgFromServiceOpenApp) msg)
        ...
        if (uzCallback != null && msg instanceof ComunicateMng.MsgFromServiceIsInitSuccess) {
            ...
            LLog.d(TAG,
                    "miniplayer STEP 3 UZVideo biet FUZVideoService da init xong -> gui lai content position cua UZVideo cho FUZVideoService");
            ComunicateMng.MsgFromActivityPosition msgFromActivityPosition = new ComunicateMng.MsgFromActivityPosition(
                    null);
            ...
            uzCallback.onStateMiniPlayer(
                    ((ComunicateMng.MsgFromServiceIsInitSuccess) msg).isInitSuccess());
        }
    }

    public void sendEventInitSuccess() {
        ComunicateMng.MsgFromActivityIsInitSuccess msgFromActivityIsInitSuccess = new ComunicateMng.MsgFromActivityIsInitSuccess(
                null);
    ...
    private void playChromecast() {
        if (UZData.getInstance().getData() == null || uzPlayerManager == null
                || uzPlayerManager.getPlayer() == null) {
            return;
        }
        showProgress();
        ...
        movieMetadata.putString(MediaMetadata.KEY_SUBTITLE,
                UZData.getInstance().getData().getDescription());
        movieMetadata
                .putString(MediaMetadata.KEY_TITLE, UZData.getInstance().getData().getEntityName());
        movieMetadata
                .addImage(new WebImage(Uri.parse(UZData.getInstance().getData().getThumbnail())));
        ...
        UZData.getInstance().getCasty().getPlayer()
                .loadMediaAndPlayInBackground(mediaInfo, true, lastCurrentPosition);

        UZData.getInstance().getCasty().getPlayer().getRemoteMediaClient()
