...
public class SensorOrientationChangeNotifier {
    ...
    public static SensorOrientationChangeNotifier getInstance(Context context) {
        if (instance == null) {
            instance = new SensorOrientationChangeNotifier(context);
        }
        return instance;
    }
    ...
    private WeakReference<SensorOrientationChangeNotifier.Listener> get(
            SensorOrientationChangeNotifier.Listener listener) {
        for (WeakReference<SensorOrientationChangeNotifier.Listener> existingListener : compositeListener) {
    ...
    private void notifyListeners() {
        ...
        for (WeakReference<SensorOrientationChangeNotifier.Listener> wr : compositeListener) {
            if (wr.get() == null) {
                deadLinksArr.add(wr);
            } else {
